...
const SignUp = () => {
  ...
  return (
    <div className="min-h-screen w-full bg-gradient-to-br from-[#0F172A] via-[#1E1B4B] to-[#312E81] relative overflow-hidden">
        ...
        >
          ...
          <div className="relative p-10">
            ...
            >
              ...
              <motion.h3
                variants={itemVariants}
                className="text-4xl font-bold text-center bg-gradient-to-r from-violet-300 to-fuchsia-300 bg-clip-text text-transparent mb-3"
              >
                Join the Adventure
                With PennyPilot
              </motion.h3>
            ...
            <form onSubmit={handleSignUp} className="space-y-6">
              ...
              <motion.div variants={itemVariants}>
                <div className="relative group">
                  <User className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-indigo-300 group-hover:text-fuchsia-400 transition-colors duration-200" />
                  <input
                    type="text"
                    value={fullName}
              ...
              <motion.div variants={itemVariants}>
                <div className="relative group">
                  <Mail className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-indigo-300 group-hover:text-fuchsia-400 transition-colors duration-200" />
                  <input
                    type="email"
                    value={email}
              ...
              <motion.div variants={itemVariants}>
                <div className="relative group">
                  <KeyRound className="absolute left-4 top-1/2 -translate-y-1/2 h-5 w-5 text-indigo-300 group-hover:text-fuchsia-400 transition-colors duration-200" />
                  <input
                    type="password"
                    value={password}
              ...
              <motion.div variants={itemVariants}>
                ...
                >
                  <div className="absolute inset-0 bg-gradient-to-r from-violet-600 to-fuchsia-600 transition-all duration-300 group-hover:scale-110" />
                  <div className="absolute inset-0 bg-gradient-to-r from-violet-600/50 to-fuchsia-600/50 blur-xl transition-all duration-300 group-hover:scale-110" />
              ...
              >
                ...
                <Link
                  to="/login"
                  className="relative font-medium text-fuchsia-400 hover:text-fuchsia-300 transition-colors group"
                >
                  <span>Log In</span>
                  <span className="absolute bottom-0 left-0 w-full h-0.5 bg-fuchsia-400 transform scale-x-0 group-hover:scale-x-100 transition-transform duration-200" />
                </Link>
              </motion.div>
            </form>
          </div>
